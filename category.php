...
#myBtn:hover {
  ...
  <section class="header-box fixed-bar">
   ...
   <h2 class="brand"><a href="index.php"> Fo<span style="color: red">rex</span>Biefly</a></h2>
...
<!--top navigation -->
        ...
        <div id="mySidenav" class="sidenav">
           ...
           <div class="main-side-container">
             ...
             <a href="category.php?catid=25"> Brokers</a>            
             <a href="category.php?catid=26"> Prop Firms</a>
