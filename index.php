...
<head>
  ...
  <title>ForexBriefly | Your Guide to Forex, Stock, Crypto, and Finance in South Africa</title>
...
<body>
  <section class="header-box fixed-bar ">
    ...
    <h2 class="brand"><a href="index.php"> Fo<span style="color: red">rex</span>Briefly</a></h2>
    


  <ul class="top-nav">
    <a href="index.php" ><li class="nav" id="c-color"> Home <i class="fa fa-circle" style="font-size: 8pt;  "></i></li></a>
    <a href="category.php?catid=24"><li class="nav"> Forex News</li></a>
    <a href="category.php?catid=25"><li class="nav"> Prop Firms</li></a>
    <a href="category.php?catid=26"><li class="nav"> Brokers</li></a>
    <a href="category.php?catid=27"><li class="nav"> Wall Of Scammers</li></a>
     </ul> 
    </section>
<!--top navigation -->
         ...
         <div id="mySidenav" class="sidenav">
            ...
            <div class="main-side-container">
              ...
              <a href="category.php?catid=24"> Forex News</a>  
              <a href="category.php?catid=25"> Prop Firms</a>            
              <a href="category.php?catid=26"> Brokers</a>
              <a href="category.php?catid=27"> Wall Of Scammers</a>
            </div>
           
            <div>
              <a href="javascript:void(0)" class="sub-side-container"> Socials</a>
              <hr>
              <a href="https://web.facebook.com/forexbriefly" class="facb"><i class="fa fa-facebook"></i> Facebook</a>
              <a href="www.instagram.com/forexbriefly" class="insg"><i class="fa fa-instagram"></i> Instagram</a>
              <a href="https://twitter.com/forexbriefly" class="twit"><i class="fa fa-twitter"></i> Twitter</a>
        ...
        <script>
            ...
            <br><br><br>  <div class="row">
                <div class="side">
                  <h5 class="categorytitlediff" > <a href="category.php?catid=24" class="News-heading">Forex News</a></h5>
...
<?php } ?>
                 ...
                 <h3><a href="category.php?catid=27" class="News-heading"> Prop Firms</a></h3>
                  <div class="imgprops" style="height:auto;">
...
<?php } ?>
                ...
                <h2><a href="category.php?catid=26" class="News-heading">Brokers</a></h2>
                  <div class="imgprops" style="height:auto;">
                 <!-- Blog Post -->   
   <?php 
         if (isset($_GET['pageno'])) {
...
<?php include('includes/sidebar.php');?>
                  ...
                  <h2><a href="category.php?catid=2" class="News-heading">Forex News</a></h2>
                  <div class="imgprops" style="height:auto;">
                 <!-- Blog Post -->   
   <?php 
         if (isset($_GET['pageno'])) {
...
<?php } ?>
                  ...
                  <h2><a href="category.php?catid=25" class="News-heading">Prop Firms</h2>
 ...
 <ul class="pagination justify-content-center mb-4">
        <li class="page-item"><a href="?pageno=1"  class="page-link">Brokers</a></li>
